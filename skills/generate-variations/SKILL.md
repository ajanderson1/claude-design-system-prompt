...
description: Use when the user asks for options or alternatives on hi-fi work ("show me a few versions", "give me some options", "explore alternatives"). Produces 3+ distinct variations across substantive axes — layout, hierarchy, interaction, tone — from basic to bold, in a single file.
---
