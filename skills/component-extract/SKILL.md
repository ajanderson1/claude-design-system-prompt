...
description: Use when the user wants reusable structure identified from a design ("identify the reusable parts", "build me a component library", "what components are here?"). Produces a component inventory with variants and states.
---
