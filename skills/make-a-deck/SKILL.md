---
name: make-a-deck
description: Use for any slide or presentation request ("make a deck", "build a presentation", "turn this into slides"). Builds a fixed-size deck shell with letterboxing and a reusable slide-layout system.
---
