---
name: ai-slop-check
description: Use when a design risks reading as generic or AI-generated ("this looks AI-made", "remove the slop", "make it less templatey") and after any greenfield hi-fi build. Detects AI-template tropes — gratuitous gradients, emoji decoration, rounded+left-border cards, hand-drawn SVG, overused fonts, the default editorial-warm house style — and fixes them.
---
