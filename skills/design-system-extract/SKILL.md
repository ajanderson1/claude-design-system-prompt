...
description: Use when design tokens need extracting from a brand, codebase, screenshots, or reference ("extract the tokens", "give me a tokens file", "pull the design system out of this"). Emits a tokens file covering color, type, spacing, radii, and shadow.
---
