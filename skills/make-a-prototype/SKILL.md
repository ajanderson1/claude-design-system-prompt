...
description: Use when the user wants something clickable or interactive ("make it interactive", "build a prototype", "make it clickable"). Builds real state, navigation, validation, loading states, and feedback — not a static mockup.
---
