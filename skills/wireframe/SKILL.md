---
name: wireframe
description: Use when the user wants to explore a flow or layout before committing to hi-fi ("explore options", "sketch some directions", "rough it out first"). Produces 3+ low-fi, greyscale, disposable variations.
---
