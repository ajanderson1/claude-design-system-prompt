...
description: Use when accessibility is questioned ("run an accessibility check", "is this WCAG-compliant?", "check keyboard nav") or as part of any pre-ship design review. Audits contrast, semantic HTML, keyboard navigation, focus states, motion preferences, and forms — then auto-fixes issues.
---
