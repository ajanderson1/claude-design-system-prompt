...
description: Use when visual hierarchy or spacing feels off ("check the hierarchy", "the spacing feels random", "this feels flat"). Checks size/weight/color signals and spacing-scale discipline, and flags off-scale values.
---
