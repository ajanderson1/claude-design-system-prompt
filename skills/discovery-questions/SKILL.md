...
description: Use at the very start of any new or ambiguous design request, before designing anything. Runs one consolidated kickoff question round to lock down output format, fidelity, option count, constraints, and which design systems / UI kits / brands are in play. Asking good questions is the biggest lever on design quality.
---
