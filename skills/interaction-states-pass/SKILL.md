...
description: Use before shipping anything interactive, or when asked to verify states ("check the button states", "does everything have hover/focus?"). Verifies hover, active, disabled, and focus states plus transitions, and adds what's missing.
---
