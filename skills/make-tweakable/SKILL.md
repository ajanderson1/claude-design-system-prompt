---
name: make-tweakable
description: Use when the user wants to adjust a finished design live ("let me play with it", "make this adjustable", "add controls I can tweak"). Adds a floating tweak panel for colors, fonts, copy, or layout variants.
---
